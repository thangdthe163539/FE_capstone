  ...
  const handleSaveAdd = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${BACK_END_PORT}/api/App/CreateApp`, {
        ...
        download: formData.download === null ? '' : formData.download,
    ...
    try {
      ...
      const response = await axios.put(
        `${BACK_END_PORT}/api/App/UpdateApplication/` + formData2.appId,
        {
          ...
          version: formData2.version === null ? '' : formData2.version,
          release: formData2.release === null ? '' : formData2.release,
          type: formData2.type,
          os: formData2.os,
          ...
          <ModalBody pb={8}>
            <Grid templateColumns='repeat(3, 1fr)' gap={4}>
              ...
              <GridItem>
                ...
                <FormControl
                  isRequired
                  isInvalid={isFirst.db ? false : !formData2.db ? true : false}
                  className={styles.formInput}
                >
                  <Flex>
            ...
            <Grid templateColumns='repeat(3, 1fr)' gap={4}>
              ...
              <GridItem>
                ...
                <FormControl
                  isRequired
                  isInvalid={
                    isFirst.language ? false : !formData.language ? true : false
                  }
                  className={styles.formInput}
                >
                  <Flex>
                ...
                <FormControl
                  isRequired
                  isInvalid={isFirst.db ? false : !formData.db ? true : false}
                  className={styles.formInput}
                >
                  <Flex>
                    <FormLabel>Database</FormLabel>
