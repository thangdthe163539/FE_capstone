...
function AssetsPage() {
  ...
  return (
    <Box className={styles.bodybox}>
        <List>
            <ListItem className={styles.list}><Link href="/pmpages/pmhome" _hover={{ textDecor: 'underline' }} className={styles.listitem}>Home</Link><ArrowForwardIcon margin={1}></ArrowForwardIcon>Management Assets</ListItem>
            ...
            <TableContainer>
                <Table variant='simple'>
                  <TableCaption>Total 3 assets</TableCaption>
                  <Thead>
                    <Tr>
                      <Th isNumeric>Device ID</Th>
                      <Th>Account</Th>
                      <Th>Name</Th>
                      <Th>IP Address</Th>
                      <Th>MAC Address</Th>
                  ...
                  <Tbody>
                    <Tr>
                      ...
                      <Td>dev laptop</Td>
                      <Td>192.168.0.5</Td>
                      <Td>0E:A2:C9:58:47:31</Td>
                      <Td>Intel Corporate</Td>
                      <Td>Surface Go 2</Td>
                      <Td>MP2BQKYM</Td>
                      <Td>2023-09-12 · 12:57:29</Td>
                      <Td>Active</Td>
                    </Tr>
                    <Tr>
                      <Td isNumeric>1</Td>
          ...
          <ModalContent>
            ...
            <FormControl>
              ...
              <Select name="status" value={formData.status} onChange={handleInputChange}>
                ...
                <option value="disable">Dis</option>
              </Select>
            </FormControl>      
            </ModalBody>
            <ModalFooter>
