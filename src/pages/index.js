...
function SignInPage() {
  return (
    <Box style={{
      ...
      <Flex style={{ justifyContent: 'left', paddingLeft: '4%', paddingTop: '200px' }}>
        <Text style={{ letterSpacing: '5px', fontSize: '40px', color: 'white' }}>SOFTTRACK</Text>
      </Flex>
      <hr style={{ borderTop: '1px solid white', width: '20%', marginTop: '0.5%', marginLeft: '4%' }} />
